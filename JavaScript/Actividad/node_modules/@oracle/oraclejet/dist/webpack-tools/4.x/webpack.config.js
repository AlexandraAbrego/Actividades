...
module.exports = {
  ...
  resolve: {
    alias: {
      ...
      'ojs': path.resolve(__dirname, './web/js/libs/oj/15.1.3/debug'),
      'ojtranslations': path.resolve(__dirname, './web/js/libs/oj/15.1.3/resources'),
    ...
    new WebpackRequireFixupPlugin(
      {
        ...
        baseResourceUrl: "./web/js/libs/oj/15.1.3"
      }
    )
